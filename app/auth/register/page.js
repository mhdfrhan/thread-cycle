...
const Register = () => {
	...
	return (
		<div className="min-h-screen grid lg:grid-cols-2">
			...
			>
				<Image
					src="https://images.unsplash.com/photo-1504198458649-3128b932f49e?q=80&w=2574&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
				...
				<div className="w-full max-w-md">
					<div className="text-center lg:text-left mb-8">
						...
						<p className="text-neutral-600 dark:text-neutral-400">
							Bergabunglah dengan kami dan mulai menjelajahi platform ThreadCycle
						</p>
					</div>
					...
					<form onSubmit={handleSubmit} className="space-y-6">
						<div>
							...
							<div className="relative">
								<input
									...
									className="w-full px-4 py-3 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-xl focus:ring-2 focus:ring-orange-500 dark:focus:ring-orange-600 focus:border-transparent dark:text-white transition-all duration-200"
								/>
							</div>
						</div>
						<div>
						...
						<div className="relative my-8">
							...
							<div className="relative flex justify-center text-sm">
								<span className="px-2 bg-white dark:bg-neutral-950 text-neutral-500">Atau daftar dengan</span>
							</div>
						</div>
