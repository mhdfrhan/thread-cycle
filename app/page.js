...
const Home = () => {
  ...
  const steps = [
    {
      ...
      description:
        "Punya pakaian yang nganggur di lemari? Yuk, bagikan dengan kami! Makin bagus kondisinya, makin banyak poin yang kamu dapat. ✨",
      icon: "📸",
    },
    {
      id: 2,
      ...
      description:
        "Jelajahi koleksi keren dari member lain. Beli langsung atau tukar pakai poin dari pakaianmu. Gampang banget! 🛍️",
      icon: "🔄",
    },
    {
      id: 3,
      ...
      description:
        "Kami pastikan barang yang kamu beli sampai dengan aman dan cepat. Tidak perlu khawatir lagi! 🚚",
      icon: "📦",
    },
    {
      id: 4,
      ...
      description:
        "Lihat dampak positifmu untuk lingkungan dan dapatkan hadiah keren setiap mencapai milestone. Kamu memang hebat! 🌟",
      icon: "🌱",
    },
  ];
  ...
  const featuredItems = [
    {
      ...
      description:
        "Temukan koleksi pakaian musim panas terbaik dengan harga spesial",
      image:
        "https://images.pexels.com/photos/27045937/pexels-photo-27045937/free-photo-of-young-woman-wearing-floral-clothing-and-eyewear-sitting-in-city.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      category: "Musiman",
    },
    {
      id: 2,
      name: "Brand Premium",
      description:
        "Pilihan pakaian branded berkualitas dengan harga terjangkau",
      image:
        "https://images.unsplash.com/photo-1509319117193-57bab727e09d?q=80&w=2574&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      category: "Premium",
    },
    {
      id: 3,
      ...
      image:
        "https://images.pexels.com/photos/6068960/pexels-photo-6068960.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      category: "Vintage",
    },
  ];
      ...
      items: [
        {
          ...
          answer:
            "ThreadCycle adalah platform yang memungkinkan Anda untuk menukar pakaian bekas berkualitas dengan pengguna lain. Kami mendorong fashion berkelanjutan dan mengurangi limbah tekstil.",
        },
        {
          question: "Bagaimana cara bergabung dengan ThreadCycle?",
          answer:
            "Anda dapat mendaftar secara gratis melalui halaman registrasi. Setelah verifikasi email, Anda dapat mulai menjelajahi dan menukar pakaian.",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          answer:
            "Setiap pakaian yang Anda tukarkan akan diberikan nilai poin berdasarkan kualitas, merek, dan kondisi. Poin ini dapat Anda gunakan untuk menukar dengan pakaian lain.",
        },
        {
          question: "Bagaimana proses pengiriman pakaian?",
          answer:
            "Setelah pertukaran disetujui, Anda akan mendapatkan label pengiriman. Kami bekerja sama dengan berbagai jasa kurir untuk memastikan pakaian sampai dengan aman.",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          answer:
            "Setiap pakaian melalui proses verifikasi ketat. Kami memeriksa keaslian, kondisi, dan kebersihan sebelum diizinkan untuk ditukar.",
        },
        {
          question: "Apa yang terjadi jika saya menerima pakaian yang rusak?",
          answer:
            "Kami memiliki garansi 24 jam. Jika Anda menerima pakaian yang tidak sesuai deskripsi, kami akan mengembalikan poin Anda.",
        },
      ],
    },
  ];
  ...
  return (
    <>
      ...
      <section
        className="overflow-hidden max-w-7xl mx-auto px-4 py-16"
        data-aos="fade-up"
      >
      ...
      <section className="overflow-hidden max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-8" data-aos="fade-up">
          ...
          <p className="text-sm sm:text-lg text-neutral-400 max-w-2xl mx-auto">
            Bergabunglah dengan revolusi fashion berkelanjutan dalam 4 langkah
            sederhana
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {steps.map((step, index) => (
            <div key={step.id} data-aos="fade-up" data-aos-delay={index * 100}>
      ...
      <section className="overflow-hidden py-16 bg-neutral-50 dark:bg-neutral-950">
        ...
        <div>
            ...
            <div className="hidden lg:block lg:absolute lg:bottom-8 lg:left-8">
              <div className="max-w-2xl mx-auto text-left text-white">
                <h2 className="text-2xl md:text-4xl lg:text-5xl font-semibold mb-4">
                  Bergabunglah dengan ThreadCycle
                </h2>
                <p className="text-sm sm:text-lg max-w-lg mb-8">
                  Temukan pakaian bekas berkualitas dengan harga terjangkau.
                  Dapatkan poin dengan mengunggah pakaian Anda dan tukar dengan
                  pakaian lain yang Anda inginkan.
                </p>
                <Link href={"/auth/login"}>
                  <button className="px-6 py-3 bg-orange-600 text-white font-medium rounded-full hover:bg-orange-700 transition-all duration-300">
                    Mulai Sekarang
                  </button>
                </Link>
              </div>
          ...
          <div className="lg:hidden mt-4">
            <div className="text-left dark:text-white">
              ...
              <p className="text-sm sm:text-lg max-w-lg mb-8 dark:text-neutral-400 text-neutral-500">
                Temukan pakaian bekas berkualitas dengan harga terjangkau.
                Dapatkan poin dengan mengunggah pakaian Anda dan tukar dengan
                pakaian lain yang Anda inginkan.
              </p>
      ...
      <section className="pt-6 md:py-16 relative">
        <TextSlider
          texts={['ThreadCycle', 'ThreadCycle']}
          velocity={velocity}
        />

        <div className="absolute top-0 left-0 w-40 sm:w-60 lg:w-1/3 h-full bg-gradient-to-r from-white to-transparent dark:from-neutral-950"></div>
        <div className="absolute top-0 right-0 w-40 sm:w-60 lg:w-1/3 h-full bg-gradient-to-l from-white to-transparent dark:from-neutral-950"></div>
      </section>
      ...
      <section className="overflow-hidden max-w-7xl mx-auto px-4 py-16">
        <div>
          <div className="max-w-sm mx-auto lg:max-w-none py-12">
            <h1
              className="text-2xl md:text-4xl lg:text-5xl font-semibold text-neutral-800 dark:text-white mb-4 flex justify-center items-center text-center"
              data-aos="fade-up"
            >
              <span className="text-orange-500">
                <svg
            ...
            <p
              className="text-sm sm:text-lg text-neutral-400 max-w-2xl mx-auto text-center mb-8"
              data-aos="fade-up"
              data-aos-delay="100"
            >
              Jelajahi koleksi produk yang tersedia di ThreadCycle dan temukan
              pakaian bekas berkualitas dengan harga yang terjangkau.
            </p>

            <div className="flex flex-wrap -mx-2 lg:-mx-4 -mb-8 items-center">
              <div
                className="w-full sm:w-3/12 px-2 lg:px-4 mb-4 lg:mb-8"
                data-aos="fade-right"
              >
              ...
              <div
                className="w-full sm:w-6/12 px-2 lg:px-4 mb-4 lg:mb-8"
                data-aos="zoom-in"
                data-aos-delay="200"
              >
      ...
      <section className="overflow-hidden  py-16 bg-neutral-50 dark:bg-neutral-900">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="space-y-8">
            {faqs.map((category, categoryIndex) => (
              <div
                ...
                className="bg-white dark:bg-neutral-800 rounded-2xl p-6 shadow-sm"
              >
          ...
          <div className="mt-16 text-center">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center px-6 py-3 text-base font-medium rounded-full text-white bg-orange-500 hover:bg-orange-600 transition-colors"
            >
              Hubungi Kami
              <svg
      ...
      <section className="overflow-hidden max-w-7xl mx-auto px-4 py-16">
        <div className="mb-8" data-aos="fade-up">
          ...
          <p className="text-sm sm:text-lg text-neutral-400 max-w-2xl mx-auto text-center mb-8">
            Dapatkan pengalaman berbelanja yang lebih mudah dan nyaman dengan
            aplikasi ThreadCycle
          </p>
        </div>

        <div data-aos="zoom-in">
          <Image
            src={"/img/application-mockup.png"}
