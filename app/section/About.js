    ...
    <div className="flex flex-wrap -mx-4 items-center">
      ...
      <div className="w-full md:w-1/2 px-4 mt-8 md:mt-0">
        ...
        <p className="text-neutral-600 dark:text-neutral-400 mb-8">
          ThreadCycle adalah platform inovatif yang menghubungkan komunitas fashion berkelanjutan.
          Kami berkomitmen untuk mengurangi limbah tekstil dan menciptakan masa depan fashion yang lebih ramah lingkungan.
        </p>
